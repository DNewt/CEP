...
let counter = 0;
function createData(CodeKey, Type, Description, Currency, Unit, Cost, DateModified, TPApprover) {
  counter += 1;
  return { id: counter, CodeKey, Type, Description, Currency, Unit, Cost, DateModified, TPApprover };
}
